    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <!-- Page Title -->
                <h1 class="font-weight-bold text-white">{!! __('terms.title') !!}</h1>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="block">
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="https://www.mapbox.com/legal/tos" target="_blank" rel="noopener noreferrer">Mapbox</a>
                            </li>
                        </ul>
                    </div>
                    <p>
                    ...
                    <p><strong>{!! __('terms.title.p11') !!}</strong></p>
                    <p>
                        {!! __('terms.p11') !!}
                    </p>
                    <p>
                    ...
                    <p><strong>{!! __('terms.title.p13') !!}</strong></p>
                    <p>
                        {!! __('terms.p13') !!}
                    </p>
                </div>
